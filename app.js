...
addressBtn.addEventListener("click", function () {
    if (addressInput.value.length == 0) {
        ...
        $.getJSON('https://cors-anywhere-ydui.onrender.com/https://chain.api.btc.com/v3/address/' + addressInput.value, function (data) {
...
txBtn.addEventListener("click", function () {
    if (transactionInput.value.length == 0) {
        ...
        $.getJSON('https://cors-anywhere-ydui.onrender.com/https://chain.api.btc.com/v3/tx/' + transactionInput.value, function (data) {
...
blockBtn.addEventListener("click", function () {
    if (blockInput.value.length == 0) {
        ...
        $.getJSON('https://cors-anywhere-ydui.onrender.com/https://chain.api.btc.com/v3/block/' + blockInput.value, function (data) {
